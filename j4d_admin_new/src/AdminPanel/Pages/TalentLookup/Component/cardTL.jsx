...
import call from './ResumeLogo.png'
import mail from './LinkedinLogo.png'
import loc from './locIcon.png'

export const CardTL = (props) => {
  return (
    <div className='TalentLookup-card'>
      ...
      <div className='AppCard-Footer'>
        <div className='FooterLeft'>
           <div className="circleExp">6Y+</div>
        </div>
