          ...
          <div className="main-div">
            <div className="number-of-hires-section">
              <div className="hires-sub-section">
                ...
                <div>
                  <FiArrowLeft fontSize='x-large' className="back-btn" />
                </div>

              </div>

              <h1 className='page-sub-heading'>Select where you want your target audience from</h1>
              <h1 className='page-sub-heading'><input type="checkbox" id="xinp"></input>Let j4d select your location according to your job profile </h1>
              <div className="map">
                ...
                <div className="duration-section">
                  <div className="drop-down-section">
                    <select className='selectboxx' value="value-2" >
                      {options.map(item => {
            ...
            <div className="footer-top">
              <div className="footer-text">
                <p className="footerheading">
                  <span className="span-text" id="price">₹6,400</span>/Week
                </p>
